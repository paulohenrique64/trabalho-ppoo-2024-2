 ...
 * 
 * - {@link #INDO_PARA_ENTRADA_ESTACIONAMENTO}: O veículo está a caminho
 * da entrada do estacionamento.
 * - {@link #INDO_ESTACIONAR}: O veículo está a caminho de uma vaga
 * de estacionamento.
 * - {@link #INDO_EMBORA_DO_ESTACIONAMENTO}: O veículo está saindo do
 * estacionamento e indo para fora do Mapa.
 * 
